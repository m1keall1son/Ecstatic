...
///COMPONENTS ----------------------------------------------------------------//
    ...
    EventType UpdateComponentsEvent::TYPE = getHash("update_components_event");
    
    UpdateComponentsEventRef UpdateComponentsEvent::create( const TimeStepType &delta )
    {
        return UpdateComponentsEventRef( new UpdateComponentsEvent( delta ) );
    }
    
    UpdateComponentsEvent::UpdateComponentsEvent( const TimeStepType &delta   ) : ec::EventData( cinder::app::getElapsedSeconds() ), mDelta( delta ){}
    
    const char* UpdateComponentsEvent::getName() const
    {
        return "update_components_event";
    }
    
    EventType UpdateComponentsEvent::getEventType() const
    {
        return UpdateComponentsEvent::TYPE;
    }
    
    //CULL VISIBLE COMPONENTS  ----------------------------------------------------//
    
    EventType CullVisibleComponentsEvent::TYPE = getHash("cull_visible_components_event");
    
    CullVisibleComponentsEventRef CullVisibleComponentsEvent::create( const TimeStepType &delta )
    {
        return CullVisibleComponentsEventRef( new CullVisibleComponentsEvent( delta ) );
    }
    
    CullVisibleComponentsEvent::CullVisibleComponentsEvent( const TimeStepType &delta   ) : ec::EventData( cinder::app::getElapsedSeconds() ), mDelta( delta ){}
    
    const char* CullVisibleComponentsEvent::getName() const
    {
        return "cull_visible_components_event";
    }
    
    EventType CullVisibleComponentsEvent::getEventType() const
    {
        return CullVisibleComponentsEvent::TYPE;
    }
    
    //CULL VISIBLE COMPONENTS  ----------------------------------------------------//
    
    EventType DrawVisibleComponentsEvent::TYPE = getHash("draw_visible_components_event");
    
    DrawVisibleComponentsEventRef DrawVisibleComponentsEvent::create( const TimeStepType &delta )
    {
        return DrawVisibleComponentsEventRef( new DrawVisibleComponentsEvent( delta ) );
    }
    
    DrawVisibleComponentsEvent::DrawVisibleComponentsEvent( const TimeStepType &delta   ) : ec::EventData( cinder::app::getElapsedSeconds() ), mDelta( delta ){}
    
    const char* DrawVisibleComponentsEvent::getName() const
    {
        return "draw_visible_components_event";
    }
    
    EventType DrawVisibleComponentsEvent::getEventType() const
    {
        return DrawVisibleComponentsEvent::TYPE;
    }
